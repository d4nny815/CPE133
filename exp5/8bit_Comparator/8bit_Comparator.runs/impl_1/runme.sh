...
HD_PWD='D:/schoolfiles/School/cpe 133/exp5/8bit_Comparator/8bit_Comparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eight_bit_comp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eight_bit_comp.tcl -notrace
