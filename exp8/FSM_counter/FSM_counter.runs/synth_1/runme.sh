...
HD_PWD='D:/schoolfiles/School/cpe 133/exp8/FSM_counter/FSM_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cntr_up_down.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cntr_up_down.tcl
