...
HD_PWD='D:/schoolfiles/School/cpe 133/exp8/FSM_counter/FSM_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cntr_up_down.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cntr_up_down.tcl -notrace
