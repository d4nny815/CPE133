...
HD_PWD='D:/schoolfiles/School/cpe 133/exp7/signed_5b_adder/signed_5b_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signed_5b_adder_t_sseg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signed_5b_adder_t_sseg.tcl
