...
HD_PWD='D:/schoolfiles/School/cpe 133/exp7/signed_5b_adder/signed_5b_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log signed_5b_adder_t_sseg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source signed_5b_adder_t_sseg.tcl -notrace
