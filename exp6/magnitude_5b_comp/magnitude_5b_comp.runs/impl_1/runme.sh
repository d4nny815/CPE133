...
HD_PWD='D:/schoolfiles/School/cpe 133/exp6/magnitude_5b_comp/magnitude_5b_comp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mag_comp_5b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mag_comp_5b.tcl -notrace
