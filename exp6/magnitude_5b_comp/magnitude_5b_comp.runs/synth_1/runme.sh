...
HD_PWD='D:/schoolfiles/School/cpe 133/exp6/magnitude_5b_comp/magnitude_5b_comp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mag_comp_5b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mag_comp_5b.tcl
